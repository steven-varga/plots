 ...
 */
#ifndef  H5PLOT_META_HPP
#define  H5PLOT_META_HPP

#include <type_traits>
#include <optional>

namespace plot::impl::compat {
...
namespace plot::impl { // feature detection
	using plot::impl::compat::is_detected;
